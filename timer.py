...
class TerminalTimer:
    ...
    def display_timer(self, remaining_seconds, total_seconds):
        """타이머 화면을 표시합니다."""
        self.clear_screen()
    ...
    def countdown(self, total_seconds):
        ...
        try:
            while remaining_seconds > 0 and self.is_running:
                self.display_timer(remaining_seconds, total_seconds)
...
def main():
    ...
    try:
        while True:
            # 사용자 입력 받기
            total_seconds = timer.get_user_input()
